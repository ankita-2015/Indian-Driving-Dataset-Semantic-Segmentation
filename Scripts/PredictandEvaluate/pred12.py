...
path = f"../../RESULTS/{foldername}/output_result_IDD"
csv_path = f"../../RESULTS/{foldername}/TestResult_{epoch_num}_IDD.csv"
...
test_images_folder_path = "../../Dataset/IDD/Test/images/*"
test_mask_folder_path="../../Dataset/IDD/Test/masks/*"
